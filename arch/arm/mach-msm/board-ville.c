...
static struct single_row_lut fcc_temp_id_4 = {
	.x	= {-20, -10, 0, 5, 10, 20, 30, 40},
	.y	= {1540, 1543, 1623, 1715, 1759, 1794, 1785, 1780},
	.cols	= 8,
};

static struct single_row_lut fcc_sf_id_4 = {
	.x	= {100, 200, 300, 400, 500},
	.y	= {100, 97, 96, 93, 90},
	.cols	= 5,
};

static struct sf_lut pc_sf_id_4 = {
	.rows		= 10,
	.cols		= 5,
...
static struct pc_temp_ocv_lut  pc_temp_ocv_id_4 = {
	.rows		= 29,
	.cols		= 8,
	.temp		= {-20, -10, 0, 5, 10, 20, 30, 40},
	.percent	= {100, 95, 90, 85, 80, 75, 70, 65, 60, 55,
...
struct pm8921_bms_battery_data  bms_battery_data_id_4 = {
	.fcc			= 1780,
	.fcc_temp_lut		= &fcc_temp_id_4,
	.fcc_sf_lut		= &fcc_sf_id_4,
	.pc_temp_ocv_lut	= &pc_temp_ocv_id_4,
	.pc_sf_lut		= &pc_sf_id_4,
};
...
static struct htc_battery_cell htc_battery_cells[] = {
	...
	[3] = {
		...
		.voltage_min = 3200,
		.chg_param = &chg_batt_params[0],
		.gauge_param = &bms_battery_data_id_4,
	},
	[4] = {
		.model_name = "UNKNOWN",
		.capacity = 1650,
